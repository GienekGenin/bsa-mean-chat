...
var ChatComponent = (function () {
    ...
    ChatComponent.prototype.ngOnInit = function () {
        ...
        this._socketService.on('Server_asking', function (data) {
            console.log(data.msg);
            _this._socketService.emit('Client_response', {
                msg: 'Yes, its working for me!'
            });
            _this._socketService.on('Server_response', function (_data) {
                console.log(_data.msg);
            });
        });
        this._socketService.on('new_connection', function (_data) {
            _this.messages = _data.messages;
        });
